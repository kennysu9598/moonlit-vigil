...
**[下载 Windows 版](https://github.com/kennysu9598/moonlit-vigil/releases/tag/v0.5.0)** · **[参与开发](CONTRIBUTING.md)** · **[素材与许可](ASSET_LICENSES.md)**

![Windows 实战画面](docs/images/battle-phoenix.jpg)

## 直接玩

1. 打开上面的下载页，下载 `MoonlitVigil-v0.5.0-windows-x86_64.zip`。
...
这是 **v0.5.0 原型**，完成一场战斗，不是完整商业 RPG。本版补齐完整声音链路：三曲制 BGM（战斗 / 胜利 / 败北）、6 单位 × 6 情境的角色配音、总线级音频管理与总线级静音，并加入出手预备、命中顿帧、受击闪白、伤害飘字等战斗手感。两套灵兽主特效已通过本轮画面检查；其他未达到人物精细度的主特效保持关闭，技能规则仍可使用。凤凰只有四个关键姿态；人物也是有限姿态动画。Windows 包使用 Godot GUI 运行器 + PCK，可能显示 DEBUG 标题。Mac/Linux 尚未发行、未实测。
