...
| `assets/audio/ui_*.ogg`, `hit.ogg`, `heal.ogg`, `shield.ogg` | [Kenney Interface Sounds](https://kenney.nl/assets/interface-sounds) | CC0-1.0 |
| `assets/audio/impact_*.ogg` | [Kenney Impact Sounds](https://kenney.nl/assets/impact-sounds) | CC0-1.0 |
| `assets/audio/battle_theme.ogg` | [Determined Pursuit (epic orchestra loop)](https://opengameart.org/content/determined-pursuit-epic-orchestra-loop) — Emma_MA; converted WAV to Ogg Vorbis | CC0-1.0 |
